...
if (process.env.VCAP_SERVICES) {
  ...
  config.redis.host = conf['redis-2.4'][0].credentials.host;
  config.redis.port = conf['redis-2.4'][0].credentials.port;
  config.redis.pass = conf['redis-2.4'][0].credentials.password;
}
